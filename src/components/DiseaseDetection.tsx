  ...
  return (
    <div className="min-h-screen pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        ...
        <div className="bg-slate-50/50 backdrop-blur-md rounded-[32px] border border-slate-100 shadow-sm overflow-hidden p-1">
           <DiseaseScanner />
        </div>

        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-md">
            <h3 className="font-black text-slate-800 mb-2 uppercase text-xs tracking-widest">How it works</h3>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-md">
            <h3 className="font-black text-slate-800 mb-2 uppercase text-xs tracking-widest">Accuracy</h3>
            <p className="text-sm text-slate-600 font-semibold leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-md">
            <h3 className="font-black text-slate-800 mb-2 uppercase text-xs tracking-widest">Privacy</h3>
            <p className="text-sm text-slate-600 font-semibold leading-relaxed">
